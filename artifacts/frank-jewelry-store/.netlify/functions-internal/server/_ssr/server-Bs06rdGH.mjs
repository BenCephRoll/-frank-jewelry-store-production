...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DGFqenLV.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DzH1degG.mjs").then((n) => n.t),
		import("./start-7mbtLB2Y.mjs"),
		import("./empty-plugin-adapters-vYsNxJMZ.mjs")
	]);
	return {
		routerEntry,
		startEntry,
